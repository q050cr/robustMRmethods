...
For all scenarios (a. all instruments, b. common+strong, c. common+weak, d. rare+strong, e. rare+weak) we need to describe our results for a smaller set of sample sizes. 
...
# name list
names(df_metrics_all_scenarios) <- c("scenario_ALL_INSTR", "STRONG_COMMON", "STRONG_RARE", "WEAK_COMMON", "WEAK_RARE")
```
