...
est_sim <- readRDS(file = "../output/Rdata/2022-11-18_est_sim.rds")

est_sim <- readRDS(file = "../output/Rdata/2022-11-22_est_sim_NSIM_5.rds")
```
...
fig01b.update +
  ...
  geom_boxplot(data = test, aes(x=sample_size_filtered, y=value*100, # *100 to get percent values
                                group=sample_size_filtered), 
               col=ggthemes_data$few$colors$Dark[3,2][[1]],
               alpha=0.6)+

ggplot(test, aes(x=as.factor(sample_size_filtered), y=value))+
  geom_boxplot()
