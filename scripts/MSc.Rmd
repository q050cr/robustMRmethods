...
ggpubr::ggarrange(fig01b.update.arrange, fig02.update.arrange,
                  gfigure01_EFFECT_SIZE_strong_VARIANTS_common.arrange, figure01_EFFECT_SIZE_strong_VARIANTS_rare.arrange,
...
figure01_EFFECT_SIZE_strong_VARIANTS_rare.arrange+
  scale_y_continuous(name="", sec.axis = sec_axis(~./scale_factor, name=""), limits = c(0,2))
...
#              ) 
#colnames(est_sim) <- c(paste0("theta_sim_", n), paste0("theta_se_sim_", n))
...
ggplot(boxplot_dat, aes(x=forcats::fct_rev( as.factor(theta_sim_numeric)), y=value)) +
  ...
  #scale_x_discrete(name = paste0("Size of sample ", as.roman(1)),  breaks = c(" 50000", "100000", "200000", "300000"), )+ 
