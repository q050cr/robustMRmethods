...
est.bmi.gsd <- readRDS(dplyr::last(list.files("../output/Rdata/", pattern = "_est_BMI_GSD.rds", full.names = TRUE))) 
...
est_sim <- readRDS(dplyr::last(list.files(path = "../output/Rdata", pattern = "_est_sim_purrr_NSIM_", full.names = TRUE)))
est_sim_architectures <- readRDS(dplyr::last(list.files(path = "../output/Rdata", pattern = "_est_sim_architectures_purrr_NSIM_", full.names = TRUE)))
nsim <- nrow(est_sim)
```
...
## GSD  we loop in the next section and save the files there with all references!
...
# #5
# filename_MEDIAN_GSD_performance_metrics <- paste0("../output/performance_metrics/", 
#                                                Sys.Date(), "_MEDIAN_GSD_performance_metrics_NSIM_", nsim, ".csv")
# #6
# filename_EGGER_GSD_performance_metrics <- paste0("../output/performance_metrics/", 
#                                                Sys.Date(), "_EGGER_GSD_performance_metrics_NSIM_", nsim, ".csv")
# #7
# filename_ROBUST_GSD_performance_metrics <- paste0("../output/performance_metrics/", 
#                                                Sys.Date(), "_ROBUST_GSD_performance_metrics_NSIM_", nsim, ".csv")
# #8
# filename_PRESSO_GSD_performance_metrics <- paste0("../output/performance_metrics/", 
#                                                Sys.Date(), "_PRESSO_GSD_performance_metrics_NSIM_", nsim, ".csv")
# #9
# filename_RAPS_GSD_performance_metrics <- paste0("../output/performance_metrics/", 
#                                                Sys.Date(), "_RAPS_GSD_performance_metrics_NSIM_", nsim, ".csv")
# #10
# filename_LASSO_GSD_performance_metrics <- paste0("../output/performance_metrics/", 
#                                                Sys.Date(), "_LASSO_GSD_performance_metrics_NSIM_", nsim, ".csv")
...
# #5
# write.csv2(x = MEDIAN_GSD_performance_metrics, file = filename_MEDIAN_GSD_performance_metrics)
# #6
# write.csv2(x = EGGER_GSD_performance_metrics, file = filename_EGGER_GSD_performance_metrics)
# #7
# write.csv2(x = ROBUST_GSD_performance_metrics, file = filename_ROBUST_GSD_performance_metrics)
# #8
# write.csv2(x = PRESSO_GSD_performance_metrics, file = filename_PRESSO_GSD_performance_metrics)
# #9
# write.csv2(x = RAPS_GSD_performance_metrics, file = filename_RAPS_GSD_performance_metrics)
# #10
# write.csv2(x = LASSO_GSD_performance_metrics, file = filename_LASSO_GSD_performance_metrics)
```


```{r}
#s1 <- simsum(data = est_sim, estvarname = "IVW_theta_sim_BMI_GSD_40000", se = "IVW_theta_se_sim_BMI_GSD_40000", true = est.bmi.gsd$estimate[est.bmi.gsd$mr_methods == "IVW"] )
...
for (true_method in 1:length(selected_true_methods)) {
  ...
  # STORE
  if (SAVE.files ==TRUE ){
    filename.IVW_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_IVW_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = IVW_GSD_performance_metrics, file = filename.IVW_table.performance)
    filename.MODE_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_MODE_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = MODE_GSD_performance_metrics, file = filename.MODE_table.performance)
    filename.CONMIX_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_CONMIX_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = CONMIX_GSD_performance_metrics, file = filename.CONMIX_table.performance)
    filename.MRMIX_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_MRMIX_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = MRMIX_GSD_performance_metrics, file = filename.MRMIX_table.performance)
    #5
    filename.MEDIAN_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_MEDIAN_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = MEDIAN_GSD_performance_metrics, file = filename.MEDIAN_table.performance)
    #6
    filename.EGGER_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_EGGER_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = EGGER_GSD_performance_metrics, file = filename.EGGER_table.performance)
    #7
    filename.ROBUST_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_ROBUST_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = ROBUST_GSD_performance_metrics, file = filename.ROBUST_table.performance)
    #8
    filename.PRESSO_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_PRESSO_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = PRESSO_GSD_performance_metrics, file = filename.PRESSO_table.performance)
    #9
    filename.RAPS_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_RAPS_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = RAPS_GSD_performance_metrics, file = filename.RAPS_table.performance)
    #10
    filename.LASSO_table.performance <- paste0("../output/performance_metrics/", Sys.Date(), 
                                        "_LASSO_GSD_performance_metrics_TRUE_EST_", 
                                        selected_true_methods[true_method], "_NSIM_", nsim, ".csv")
    write.csv2(x = LASSO_GSD_performance_metrics, file = filename.LASSO_table.performance)
  }
  ...
  if (SAVE.files ==TRUE ){
    #1
    filename_IVW_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_IVW_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_IVW_GSD_simplot_thetas, plot = IVW_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #2
    filename_MODE_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_MODE_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_MODE_GSD_simplot_thetas, plot = MODE_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #3
    filename_CONMIX_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_CONMIX_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_CONMIX_GSD_simplot_thetas, plot = CONMIX_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #4
    filename_MRMIX_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_MRMIX_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_MRMIX_GSD_simplot_thetas, plot = MRMIX_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #5
    filename_MEDIAN_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_MEDIAN_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_MEDIAN_GSD_simplot_thetas, plot = MEDIAN_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #6
    filename_EGGER_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_EGGER_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_EGGER_GSD_simplot_thetas, plot = EGGER_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #7
    filename_ROBUST_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_ROBUST_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_ROBUST_GSD_simplot_thetas, plot = ROBUST_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #8
    filename_PRESSO_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_PRESSO_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_PRESSO_GSD_simplot_thetas, plot = PRESSO_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #9
    filename_RAPS_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_RAPS_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_RAPS_GSD_simplot_thetas, plot = RAPS_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
    #10
    filename_LASSO_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_LASSO_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_LASSO_GSD_simplot_thetas, plot = LASSO_GSD_simplot_thetas, 
           width = 15, height = 6, 
           units = "in"  # default
           )
  }
  ...
  if (SAVE.files ==TRUE ){
    filename_GSD_simplot_thetas_arrange <- paste0("../output/plots/", Sys.Date(), "_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], "_NSIM_", nsim,".png")
    ggsave(filename = filename_GSD_simplot_thetas_arrange, plot = GSD_simplot_thetas_arrange, 
           width = 10, height = 38, 
           units = "in"  # default
           )
  ...
  if (SAVE.files ==TRUE ){
    filename_simplot_bias_mse <- paste0("../output/plots/", Sys.Date(), "_GSD_simplot_bias_mse_REF_METHOD_", selected_true_methods[true_method], "_NSIM_",nsim, ".png")
    ggsave(filename = filename_simplot_bias_mse, plot = bias_mse_plot_GSD, 
           width = 7, height = 24, 
           units = "in"  # default
           )
...
for (my_architecture in 1:length(est_sim_architectures)) {
  ...
  for (true_method in 1:length(selected_true_methods)) {
    ...
    # SAVE  --------------------------------
    # #1
    # filename_IVW_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_IVW_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], 
    #                                           "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_IVW_GSD_simplot_thetas, plot = IVW_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #2
    # filename_MODE_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_MODE_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], 
    #                                            "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_MODE_GSD_simplot_thetas, plot = MODE_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #3
    # filename_CONMIX_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_CONMIX_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], 
    #                                              "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_CONMIX_GSD_simplot_thetas, plot = CONMIX_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #4
    # filename_MRMIX_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_MRMIX_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], 
    #                                             "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_MRMIX_GSD_simplot_thetas, plot = MRMIX_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #5
    # filename_MEDIAN_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_MEDIAN_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], 
    #                                              "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_MEDIAN_GSD_simplot_thetas, plot = MEDIAN_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #6
    # filename_EGGER_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_EGGER_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method], 
    #                                             "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_EGGER_GSD_simplot_thetas, plot = EGGER_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #7
    # filename_ROBUST_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_ROBUST_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method],
    #                                              "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_ROBUST_GSD_simplot_thetas, plot = ROBUST_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #8
    # filename_PRESSO_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_PRESSO_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method],
    #                                              "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_PRESSO_GSD_simplot_thetas, plot = PRESSO_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #9
    # filename_RAPS_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_RAPS_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method],
    #                                            "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_RAPS_GSD_simplot_thetas, plot = RAPS_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    #        )
    # #10
    # filename_LASSO_GSD_simplot_thetas <- paste0("../output/plots/", Sys.Date(), "_LASSO_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method],
    #                                             "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
    # ggsave(filename = filename_LASSO_GSD_simplot_thetas, plot = LASSO_GSD_simplot_thetas, 
    #        width = 15, height = 6, 
    #        units = "in"  # default
    ...
    if (SAVE.files ==TRUE ){
      filename_GSD_simplot_thetas_arrange <- paste0("../output/plots/", Sys.Date(), "_GSD_simplot_thetas_REF_METHOD_", selected_true_methods[true_method],
                                                    "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
      ggsave(filename = filename_GSD_simplot_thetas_arrange, plot = GSD_simplot_thetas_arrange, 
             width = 10, height = 38, 
             units = "in"  # default
    ...
    if (SAVE.files ==TRUE ){
      filename_simplot_bias_mse <- paste0("../output/plots/", Sys.Date(), "_GSD_simplot_bias_mse_REF_METHOD_", selected_true_methods[true_method], 
                                          "_GenArch_", name_GenArch, "_NSIM_", nsim,".png")
      ggsave(filename = filename_simplot_bias_mse, plot = bias_mse_plot_GSD, 
             width = 7, height = 24, 
             units = "in"  # default
...
### {gt} manual stub and grouping of rows  ###
...
#df.temp.wide[[ref.method]] %>% 
  #gt(groupname_col="N") %>% 
  #gt(rowname_col = "N") %>% 
  # tab_stubhead(label = "Sample Size") %>% 
  # tab_row_group(
  #   label = "Sample Size = 50,000", 
  #   rows = 1:10
  # ) %>% 
  # tab_row_group(
  #   label = "Sample Size = 100,000", 
  #   rows = 11:20
  # ) 
...
for (ref.method in seq_along(selected_true_methods)) {
  ...
  if (SAVE.files ==TRUE ){
    filename.gt.mean.se <- paste0("../output/gt-tables/", Sys.Date(), 
  ...
  df.temp.long[[ref.method]] %>%
    ...
    if (SAVE.files ==TRUE ){
      filename.gt.performance2 <- paste0("../output/gt-tables/", Sys.Date(), 
  ...
  df.temp.long[[ref.method]] %>%
    ...
    coord_flip()+
    ggthemes::theme_few()+
    ggthemes::scale_fill_few() -> dodged.barplot.mse
