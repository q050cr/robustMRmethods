...
bias(thetaobs = est_sim$theta_sim_50000, theta = est$estimate[est$mr_methods == "conmix"])
mse(thetaobs = est_sim$theta_sim_50000, theta = est$estimate[est$mr_methods == "conmix"])
```
